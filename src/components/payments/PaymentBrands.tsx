...
export function VisaMark({ title = "Visa", className, ...rest }: Props) {
  return (
    <svg viewBox="0 0 48 32" role="img" aria-label={title} className={`${base} ${className ?? ""}`} {...rest}>
...
export function SepaMark({ title = "SEPA", className, ...rest }: Props) {
  return (
    <svg viewBox="0 0 48 32" role="img" aria-label={title} className={`${base} ${className ?? ""}`} {...rest}>
      ...
      <path
        d="M9 12.5h9.5v2.2H9v-2.2Zm0 4.4h9.5v2.2H9v-2.2Z"
        fill="#FFCC00"
      />
      <path
...
export function BankMark({ title = "Virement", className, ...rest }: Props) {
  return (
    <svg viewBox="0 0 48 32" role="img" aria-label={title} className={`${base} ${className ?? ""}`} {...rest}>
      ...
      <path d="M16 16h2.5v6H16v-6Zm6.8 0h2.5v6h-2.5v-6Zm6.7 0H32v6h-2.5v-6ZM13 23h22v2H13v-2Z" fill="#9FE8C8" />
    </svg>
  );
}
